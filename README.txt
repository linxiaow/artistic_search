...
Comment: I used v-bind:key but there might be sometimes the description and information togle doesn't work when their keys remain the same by clicking genres.